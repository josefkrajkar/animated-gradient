...
export default (props: Props) => {
  private let interval: number | undefined;
  private let step: number[][] | undefined;
  private let timer = 0;
  private let colors: number[][] | undefined;
  private let vector: number | undefined;
  private let coords: number[] | undefined = [0,0];
